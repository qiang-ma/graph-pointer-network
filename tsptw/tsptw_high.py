...
save_root ='./model/gpn_tsptw'+str(size)+'_high.pt'
load_root ='./model/gpn_tsptw'+str(size)+'_low.pt'
...
np.save('./plot/val_mean_tsptw_high',val_mean_tsptw)
np.save('./plot/val_std_tsptw_high',val_std_tsptw)
np.save('./plot/val_accuracy_high', val_accuracy)
